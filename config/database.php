    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                // TiDB production traffic is encrypted in transit. Railway/Linux
                // normally has this CA bundle; local Windows/XAMPP can leave the
                // env var empty to avoid forcing TLS against a non-TLS localhost.
